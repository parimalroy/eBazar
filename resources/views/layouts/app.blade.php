...
<html lang="en">
    ...
    <head>
        ...
        <!--Reg Form link-->
        <!--<link rel="stylesheet" type="text/css" href="{{asset('public/admin/regForm')}}/bootstrap/css/bootstrap.min.css" />-->
        <link rel="stylesheet" type="text/css" href="{{asset('public/admin/regForm')}}font-awesome/css/font-awesome.min.css" />

        <script type="text/javascript" src="{{asset('public/admin/regForm')}}js/jquery-1.10.2.min.js"></script>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">@yield('head')</a>
                </div>
                <!-- /.navbar-header -->
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{route('categorie-add')}}">Add Categories</a>
                                    </li>
                                    <li>
                                        <a href="{{route('categorie-manage')}}">Manage Categories</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Manufacture <span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{route('manufacture-add')}}">Add Manufacture</a>
                                    </li>
                                    <li>
                                        <a href="{{route('manufacture-manage')}}">Manage Manufacture</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                <a href="{{url('manage/order')}}"><i class="fa fa-table fa-fw"></i> Order Manage</a>
                            </li>
                            <li>
