...
<br/><br/><br>
<div class="row">
    <h3 class="text-success">Add Categorie</h3><hr/>
    <form role="form"action="{{route('categorie-save')}}" method="POST">
        {{csrf_field()}}
        <div class="col-sm-8">
            <div class="well">
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <input type="text" class="form-control" id="categorie_name" name="categorie_name" id="InputName">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <textarea type="text" name='categoire_description' id="categoire_description" style="resize: none" class="form-control" rows="8"></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <input type="submit" name="submit" id="submit" value="Save Categorie Info" class="btn btn-success btn-block btn-lg">
                    </div>
                </div>
            </div>
    </form>
