@extends('layouts.app')
@section('title')
E-Bazar Update Manufacture
@endsection
@section('content')
<br/><br/><br>
<div class="row">
    <h3 class="text-success">Update Manufacture</h3><hr/>
    <form role="form"action="{{route('manufacture-update')}}" name="updateForm" method="POST">
        <input type="hidden" name="manufacture_id" value="{{$manufactureById->id}}">
        {{csrf_field()}}
        <div class="col-sm-8">
            <div class="well">
                <div class="form-group">
                    <label for="manufacture_name" class="control-label col-sm-3">Categorie Name</label>
                    <div class="input-group col-sm-9">
                        <input type="text" class="form-control" id="categorie_name" name="manufacture_name" value="{{$manufactureById->manufacture_name}}" id="InputName" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-9">
                        <textarea type="text" name='manufacture_description' id="categoire_description" style="resize: none" class="form-control" rows="8">{{$manufactureById->manufacture_description}}</textarea>
...
<script>
    document.forms['updateForm'].elements['publication_status'].value = "{{$manufactureById->publication_status}}";
</script>
@endsection